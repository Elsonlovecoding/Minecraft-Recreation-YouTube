...
(3) golden apples: 2 absorption hearts for 2:00 plus 5s of regeneration
(vanilla). The yellow hearts show in their own row above the health bar and
empty completely before real health takes anything;
